...
// liste COMPLÈTE des étudiants déjà en mémoire, fournie une seule fois par le contrôleur
...
const autoCompleteJS = new autoComplete({
    ...
    debounce: 300,
    data: {
        // pas d'appel AJAX : la recherche filtre le tableau complet déjà en mémoire
        src: lesEtudiants,
        keys: ["nomPrenom"],
        cache: false
    },
    ...
    events: {
        input: {
            selection: (event) => {
                ...
                // les données complètes sont déjà en mémoire : aucun appel AJAX
                afficher(selection);
            }
        }
    }
